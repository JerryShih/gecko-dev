...
#ifndef mozilla_CrossProcessConditionVariable_h
#define mozilla_CrossProcessConditionVariable_h
...
// Provides:
//
//  - CrossProcessConditionVariable, a condition variable that can be shared
//    across processes
//
namespace mozilla {
#if defined(OS_WIN)
