...
bool
VsyncEventParent::VsyncTick(TimeStamp aTimestamp, uint64_t aFrameNumber)
{
  // Send ipc to content process.
  if (!SendNotifyVsyncEvent(VsyncData(aTimestamp, aFrameNumber))) {
