...
private:
  ...
  // Infrastructure for vsync observer.
  DECL_GFX_PREF(Once, "gfx.vsync",                             VsyncEnabled, bool, false);
  // Use vsync events generated by hardware
  DECL_GFX_PREF(Once, "gfx.vsync.hw-vsync.enabled",            HardwareVsyncEnabled, bool, true);
  DECL_GFX_PREF(Once, "gfx.vsync.compositor",                  VsyncAlignedCompositor, bool, true);
  DECL_GFX_PREF(Once, "gfx.vsync.refresh-driver",              VsyncAlignedRefreshDriver, bool, true);
