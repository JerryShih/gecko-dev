...
private:
  ...
  DECL_GFX_PREF(Once, "gfx.frameuniformity.enabled",           FrameUniformityEnabled, bool, false);
  // Force to use software vsync generator.
  DECL_GFX_PREF(Once, "gfx.frameuniformity.force.sw-vsync",    FrameUniformityForceSWVsync, bool, false);
