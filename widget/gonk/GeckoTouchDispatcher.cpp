...
GeckoTouchDispatcher::~GeckoTouchDispatcher()
{
  VsyncDispatcher::GetInstance()->GetInputDispatcherRegistry()->RemoveObserver(this, true, true);
}
  ...
  if (mResamplingEnabled) {
    switch (aData.mType) {
      case MultiTouchInput::MULTITOUCH_START:
        VsyncDispatcher::GetInstance()->GetInputDispatcherRegistry()->AddObserver(this, true);
        break;
