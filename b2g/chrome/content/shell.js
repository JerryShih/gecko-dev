...
var shell = {
  ...
  start: function shell_start() {
    ...
    systemAppFrame.setAttribute('style', "background:transparent; overflow: hidden; height: 100%; width: 100%; border: none; position: absolute; left: 0; top: 0; right: 0; bottom: 0;");
    systemAppFrame.setAttribute('src', "data:text/html;charset=utf-8,%3C!DOCTYPE html>%3Cbody style='background:transparent;");
