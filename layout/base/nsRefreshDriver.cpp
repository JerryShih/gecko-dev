...
public:
  ...
  ~VsyncRefreshDriverTimer()
  {
    ...
    VsyncDispatcher::GetInstance()->GetRefreshDriverRegistry()->Unregister(mVsyncObserver, true);
...
private:
  ...
  virtual void StartTimer() MOZ_OVERRIDE
  {
    ...
    VsyncDispatcher::GetInstance()->GetRefreshDriverRegistry()->Register(mVsyncObserver);
  }
  ...
  virtual void StopTimer() MOZ_OVERRIDE
  {
    ...
    MOZ_ASSERT(mVsyncObserver);
    VsyncDispatcher::GetInstance()->GetRefreshDriverRegistry()->Unregister(mVsyncObserver);
  }
